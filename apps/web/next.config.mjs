...
const nextConfig = {
  ...
  webpack(config, { dev }) {
    ...
    config.resolve.alias = {
      ...
      '@safe-global/sdk-starter-kit': path.resolve('../../node_modules/@gateway-fm/sdk-starter-kit'),
      '@safe-global/testing-kit': path.resolve('../../node_modules/@gateway-fm/testing-kit'),
      '@safe-global/types-kit': path.resolve('../../node_modules/@gateway-fm/types-kit'),
    }
